...
const MexicanRecipes = () => {
  const recipes = [
    ...
    },
    {
      ...
      description: 'Enchiladas are corn tortillas rolled around a filling, typically of meat or beans, covered in a chili sauce and cheese, then baked until bubbly.',
